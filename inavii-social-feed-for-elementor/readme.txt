...
- Updated Twig library to v3.x.
- Fixed conflict with the "Unlimited Elements For Elementor" plugin.

= 2.7.11 (2025-05-24) =
- Add: Introduced automatic troubleshooting tool that detects and repairs missing or unbound CRON jobs for media updates and token refresh.
- Updated Freemius SDK

= 2.7.10 (2025-05-09) =
- Upgraded to the latest version of the Instagram API.

= 2.7.9 (2025-05-05) =
- Add: Added a new Troubleshooting tab for diagnosing and resolving issues related to CRON jobs.
- Fixed: Improved the reliability and execution of CRON-related functionality.
...
= 2.7.3 (2024-11-04) =
- Fixed an issue where view paths did not work correctly in certain server configurations.

= 2.7.2 (2024-11-01) =
- Rollback previous version due to issues on some servers
